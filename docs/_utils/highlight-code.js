...
/**
 * Transformer to highlight code blocks with the `language-*` attribute using Prism.js. Unlike most plugins, this works
 * on the entire document — not just markdown content.
 */
