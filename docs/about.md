...
Quiet was built by Cory LaViska ([BlueSky](https://bsky.app/profile/cory.laviska.com) / [X](https://x.com/cory_laviska)), the creator of [Shoelace](https://shoelace.style/). With the success of Shoelace, many of you are probably wondering why I'd choose to build another UI library, and that's a reasonable question.
