...
export class QuietFileInput extends QuietFormControlElement {
  ...
  render() {
    ...
    return html`
      <label id="label" part="label" for="file-input" class=${classMap({ vh: !hasLabel })}>
      ...
      >
        <slot name="dropzone">
          ...
          <br />
          ${this.multiple
            ? this.localize.term('dragFilesHereOrChooseFromFolder')
            : this.localize.term('dragFileHereOrChooseFromFolder')}
        </slot>
